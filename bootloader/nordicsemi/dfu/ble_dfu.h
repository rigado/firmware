...
#include "ble_srv_common.h"
    ...
    #define BLE_DFU_PKT_CHAR_UUID    0x1531                                 /**< The UUID of the DFU Packet Characteristic. */
    #define BLE_DFU_CTRL_PT_UUID     0x1532                                 /**< The UUID of the DFU Control Point. */
    #define BLE_DFU_STATUS_REP_UUID  0x1533                                 /**< The UUID of the DFU Status Report Characteristic. */
#else
    #define BLE_DFU_SERVICE_UUID     0x9030                                 /**< The UUID of the DFU Service. */
    #define BLE_DFU_PKT_CHAR_UUID    0x9031                                 /**< The UUID of the DFU Packet Characteristic. */
    #define BLE_DFU_CTRL_PT_UUID     0x9032                                 /**< The UUID of the DFU Control Point. */
    #define BLE_DFU_STATUS_REP_UUID  0x9033                                 /**< The UUID of the DFU Status Report Characteristic. */
#endif
...
typedef enum
{
    BLE_DFU_CONFIG,                                                     /**< The event indicating that the peer wants the application to prepare to receive config data. */
    ...
    BLE_DFU_RECEIVE_PATCH_INIT_DATA,                                    /**< The event indicating that the perr wants the application to prepare to receive patch init data. */
    BLE_DFU_RECEIVE_PATCH_DATA,                                         /**< The event indicating that the perr wants the application to prepare to receive the patch data. */
	BLE_DFU_UNUSED, 
	BLE_DFU_RESTART 													/**< re-start DFU  */
} ble_dfu_evt_type_t;
...
typedef enum
{
    ...
    BLE_DFU_CONFIG_PROCEDURE       = 9,                                 /**< MAC and KEY configuration */
    BLE_DFU_PATCH_INIT_PROCEDURE   = 10,                                /**< Patch Initialization procedure.*/
    BLE_DFU_RECEIVE_PATCH_PROCEDURE= 11,                                /**< Patch reception process.*/
    BLE_DFU_PROTOCOL_VER_PROCEDURE = 12,                                /**< Protocol version request procedure.*/
    BLE_DFU_MAX_MTU_SIZE_PROCEDURE = 13,                                /**< Max MTU request procedure.*/
    BLE_DFU_RESTART_PROCEDURE      = 19,
} ble_dfu_procedure_t;
...
typedef enum
{
    ...
    BLE_DFU_RESP_VAL_NEED_MORE_DATA,                                    /**< More data needed.*/
    BLE_DFU_RESP_VAL_PATCH_INPUT_FULL,                                  /**< Patch input is full. */
    BLE_DFU_RESP_VAL_UNKNOWN,
} ble_dfu_resp_val_t;
