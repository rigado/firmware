...
typedef enum
{
    ...
    DFU_STATE_RX_CONFIG_PKT,                                                        /**< State for: receiving config packet. */
    DFU_STATE_CONFIGURING,                                                          /**< State for: clearing and rewriting data page */
    DFU_STATE_RX_START_PKT,                                                         /**< State for: receiving start packet. */
...
#define IS_UPDATING_SD(START_PKT)   ((START_PKT).sd_image_size != 0)
#define IS_UPDATING_BL(START_PKT)   ((START_PKT).bl_image_size != 0)
#define IS_UPDATING_APP(START_PKT)  ((START_PKT).app_image_size != 0)
#define IS_PATCHING(START_PKT)      ((START_PKT).patch_size != 0)
