...
static sw_irq_callback_id_t          m_swi_handle;
...
static void timer_list_handler_sched(void)
{
    sw_irq_manager_trigger_int(m_swi_handle);
}
                        ...
                        app_timer_evt_schedule_func_t evt_schedule_func)
{
    ...
    (void)sw_irq_manager_register_callback(swi_handler, &m_swi_handle, NULL);
