...
static sw_irq_callback_id_t          m_swi_callback_id;
...
{
    sw_irq_manager_trigger_int(m_swi_callback_id);
                        ...
                        app_timer_evt_schedule_func_t evt_schedule_func)
{
    ...
    sw_irq_manager_register_callback(timer_list_handler, &m_swi_callback_id);
