...
static uint16_t          m_event = 0;                                        /**< current command status - initially "ok", may be set if error detected, or to packet count. */
static bool              m_new_event = false;                                /**< Command has been processed - number of not yet reported event bytes. */
