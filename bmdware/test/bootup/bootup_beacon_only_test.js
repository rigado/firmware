...
function testBeaconOnly(testCompleteCallback) {
    if(!testShouldContinue) {
    ...
    async.series([
        ...
        function(callback) {
            utils.log(5, "Send AT to verify AT mode disable, timeout in 3 secs")
